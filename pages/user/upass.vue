		...
		<view class="wrapper">
			<view class="input-content">
				<view class="cu-form-group" style="border: 2upx solid whitesmoke;margin-bottom: 20px;border-radius: 30px">
					...
					<input type="number" v-model="oldpassword" placeholder="请输入原始密码" />
				</view>
				<view class="cu-form-group" style="border: 2upx solid whitesmoke;margin-bottom: 20px;border-radius: 30px">
				...
				<view class="cu-form-group" style="border: 2upx solid whitesmoke;margin-bottom: 20px;border-radius: 30px">
					...
					<input type="password" v-model="password" placeholder="请输入确认密码" />
				</view>
			</view>
			<button class="confirm-btn" @click="save">修改</button>
		</view>
	</view>
</template>
		...
		methods: {
			save() {
				if (!this.oldpassword) {
					...
					this.$Request.postT("/externalApi/revisepwd", {
						userId:uid,
